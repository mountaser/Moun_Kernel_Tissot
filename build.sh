...
echo " ";
echo " ";
rm -rf outputdTissot-4.9-Custom-Hybrid
echo " ";
echo " ";
echo " ";
...
##########################################
git cherry-pick fd4cd91a5a0f816aa48479afdc29e02a51e99221
git cherry-pick 6205db338c6a8b87ec3243d13d6646666fd8cae7
##########################################
##########################################
export ARCH=arm64
