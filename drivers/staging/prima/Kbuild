...
EXTRA_CFLAGS += $(call cc-disable-warning,maybe-uninitialized,) -Wno-unused-function -Wno-unused-variable

# Not gonna fix these warnings, clang!
ifeq ($(cc-name),clang)
EXTRA_CFLAGS += $(call cc-disable-warning,array-bounds,)
EXTRA_CFLAGS += $(call cc-disable-warning,enum-conversion,)
EXTRA_CFLAGS += $(call cc-disable-warning,non-literal-null-conversion,)
